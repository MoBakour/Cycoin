...
// console.log(
//     "%cWARNING: if you are an admin, please refrain from using the admin commands on public or foreign devices or computers",
//     "color:crimson;font-size:30px;"
// );
// console.log(
//     "%cWARNING: this console is intended for developers use only, if you are not the developer or a cycoin admin, please do not use any command here",
//     "color:yellow;font-size:30px;"
// );
// console.log(
//     "%cتحذير: وحدة التحكم هذه موجهة لاستخدام المطورين فقط، إن لم تكن المطور أو أحد مشرفي سايكوين، يرجى عدم استخدامك لأي أمر هنا",
//     "color:yellow;font-size:30px;"
// );
// console.log(
//     "%cCycoin, is an economy subject project done by AWPS senior students of grade 12B1, 2021/2022",
//     `color:rgb(${red},${green},${blue});font-size:30px;`
// );
